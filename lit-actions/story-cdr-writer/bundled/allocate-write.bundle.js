...
// lit-actions/story-cdr-writer/stamped/allocate-write.stamped.js
var ZERO_ADDRESS = "0x0000000000000000000000000000000000000000";
var EXPECTED = Object.freeze({
  actionName: "story-cdr-writer-allocate-write-v1",
  storyChainId: 1315,
  contractAddress: "0xcccccc0000000000000000000000000000000005",
  pkpAddress: "0x7d65696d4d0342d0baba3beaee9ca3a30696cb8c",
  pkpPublicKey: "0x043fac30f258f36ce3be6bd98c8a30e896f8f63e5096bae481b472f605699e96ed4996ec4201a93960fad075f1b28a2c4acb3de389b5e3a793782f66c56a7b15ff",
...
var ALLOCATE_SELECTOR = ABI_IFACE.getFunction("allocate").selector.toLowerCase();
var WRITE_SELECTOR = ABI_IFACE.getFunction("write").selector.toLowerCase();
...
async function main(firstArg) {
  ...
  const unsignedTx = {
    ...
    maxPriorityFeePerGas: BigInt(requireUintString(unsignedTxValue.maxPriorityFeePerGas ?? "0", "unsignedTx.maxPriorityFeePerGas"))
  };

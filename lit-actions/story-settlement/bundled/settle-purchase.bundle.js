...
// lit-actions/story-settlement/settle-purchase.js
...
async function resolveExpectedPrivateKey(expectedSignerAddress, expectedPkpId = null) {
  ...
  const attempts = [
    ...typeof expectedPkpId === "string" && expectedPkpId.trim() ? [{ label: "pkpId", payload: { pkpId: expectedPkpId.trim() } }] : [{ label: "pkpId", payload: { pkpId: expectedSignerAddress } }],

...
- [docs/spaces-operator-signing-contract.md](/home/t42/Documents/pirate-v2/docs/spaces-operator-signing-contract.md)
- [db/control-plane/migrations/0026_control_plane_namespace_verification_spaces.sql](/home/t42/Documents/pirate-v2/db/control-plane/migrations/0026_control_plane_namespace_verification_spaces.sql)
...
- [references/templates/api-worker-auth-first-slice/src/lib/verification-service.ts](/home/t42/Documents/pirate-v2/references/templates/api-worker-auth-first-slice/src/lib/verification-service.ts)
- [references/templates/api-worker-auth-first-slice/src/lib/sql-auth-bootstrap-store.ts](/home/t42/Documents/pirate-v2/references/templates/api-worker-auth-first-slice/src/lib/sql-auth-bootstrap-store.ts)
...
- service flow in [verification-service.ts](/home/t42/Documents/pirate-v2/references/templates/api-worker-auth-first-slice/src/lib/verification-service.ts)
- SQL writes in [sql-auth-bootstrap-store.ts](/home/t42/Documents/pirate-v2/references/templates/api-worker-auth-first-slice/src/lib/sql-auth-bootstrap-store.ts)
...
The community-create gate in [community-create-service.ts](/home/t42/Documents/pirate-v2/references/templates/api-worker-auth-first-slice/src/lib/community-create-service.ts) already checks only:
...
Spaces should use the generic challenge columns introduced in migration `0026`:
...
Add a provider layer analogous to the HNS inspector, for example:

- `references/templates/api-worker-auth-first-slice/src/lib/spaces-verification-provider.ts`
...
- [references/templates/api-worker-auth-first-slice/src/types/db.ts](/home/t42/Documents/pirate-v2/references/templates/api-worker-auth-first-slice/src/types/db.ts)
- [references/templates/api-worker-auth-first-slice/src/lib/db.ts](/home/t42/Documents/pirate-v2/references/templates/api-worker-auth-first-slice/src/lib/db.ts)
- [references/templates/api-worker-auth-first-slice/src/lib/sql-auth-bootstrap-store.ts](/home/t42/Documents/pirate-v2/references/templates/api-worker-auth-first-slice/src/lib/sql-auth-bootstrap-store.ts)
- [references/templates/api-worker-auth-first-slice/src/lib/verification-service.ts](/home/t42/Documents/pirate-v2/references/templates/api-worker-auth-first-slice/src/lib/verification-service.ts)
- [references/templates/api-worker-auth-first-slice/src/namespace-verification.test.ts](/home/t42/Documents/pirate-v2/references/templates/api-worker-auth-first-slice/src/namespace-verification.test.ts)
- [scripts/lib/control-plane-fixtures.ts](/home/t42/Documents/pirate-v2/scripts/lib/control-plane-fixtures.ts)
...
- [references/templates/api-worker-auth-first-slice/src/namespace-verification.test.ts](/home/t42/Documents/pirate-v2/references/templates/api-worker-auth-first-slice/src/namespace-verification.test.ts)
- [references/templates/api-worker-auth-first-slice/src/community-create-and-registry.test.ts](/home/t42/Documents/pirate-v2/references/templates/api-worker-auth-first-slice/src/community-create-and-registry.test.ts)

...
Defines the first concrete relational schema for Pirate's central Turso control-plane database.
...
- Turso/libSQL
- SQLite-compatible schema and index rules
...
- `challenge_expires_at` text nullable
...
- `status` text not null
- `first_accepted_at` text nullable
- `last_revalidated_at` text nullable
- `created_at` text not null
- `updated_at` text not null
...
- `role_summary_json` text nullable

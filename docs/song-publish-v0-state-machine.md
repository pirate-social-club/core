...
- real CDR SDK vault bootstrap and encrypted-payload write
- real Story sponsor/backend-signer router integration
- signed buyer retrieval tokens or temporary proof material beyond the stored delivery ref decision

...
const TYPE_EXPORTS = [
  ...
  { name: "DanceSessionMutationResponse", ref: "#/components/schemas/DanceSessionMutationResponse" },
  { name: "DanceSessionCreateRequest", ref: "#/components/schemas/DanceSessionCreateRequest" },
  { name: "DanceConsentAcceptance", ref: "#/components/schemas/DanceConsentAcceptance" },
  { name: "DanceSessionUploadIntentRequest", ref: "#/components/schemas/DanceSessionUploadIntentRequest" },
  { name: "DanceSessionUploadIntent", ref: "#/components/schemas/DanceSessionUploadIntent" },
  { name: "DanceSessionSubmitRequest", ref: "#/components/schemas/DanceSessionSubmitRequest" },
  { name: "DanceSessionSubmission", ref: "#/components/schemas/DanceSessionSubmission" },
...
const ROUTE_EXPORTS = [
  ...
  { name: "danceSessions", path: "/dance-sessions" },
  ...
  { name: "danceSessionUploadIntent", path: "/dance-sessions/{dance_session_id}/upload-intent" },
  { name: "danceSessionSubmit", path: "/dance-sessions/{dance_session_id}/submit" },

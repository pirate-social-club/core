...
const ROUTE_EXPORTS = [
  ...
  { name: "agentCredentialRefresh", path: "/agents/{agent_id}/refresh_credential" },
  ...
  { name: "communityPurchaseSettlementFailures", path: "/communities/{community_id}/fail_purchase_settlement" },

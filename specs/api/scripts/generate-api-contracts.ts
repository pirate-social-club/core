...
const TYPE_EXPORTS = [
  ...
  { name: "BookingStatus", ref: "#/components/schemas/BookingStatus" },
  { name: "BookingViewerRole", ref: "#/components/schemas/BookingViewerRole" },
  { name: "BookingView", ref: "#/components/schemas/BookingView" },
  { name: "BookingListResponse", ref: "#/components/schemas/BookingListResponse" },
  { name: "BookingDetailResponse", ref: "#/components/schemas/BookingDetailResponse" },
  { name: "BookingSlot", ref: "#/components/schemas/BookingSlot" },
  ...
  { name: "BookingHold", ref: "#/components/schemas/BookingHold" },
  { name: "BookingHoldResponse", ref: "#/components/schemas/BookingHoldResponse" },
  { name: "BookingPaymentInstructions", ref: "#/components/schemas/BookingPaymentInstructions" },
  { name: "BookingQuote", ref: "#/components/schemas/BookingQuote" },
  { name: "BookingQuoteResponse", ref: "#/components/schemas/BookingQuoteResponse" },
  { name: "ConfirmBookingHoldRequest", ref: "#/components/schemas/ConfirmBookingHoldRequest" },
  { name: "BookingSnapshot", ref: "#/components/schemas/BookingSnapshot" },
  { name: "BookingConfirmResponse", ref: "#/components/schemas/BookingConfirmResponse" },
  { name: "BookingLifecycleSnapshot", ref: "#/components/schemas/BookingLifecycleSnapshot" },
  { name: "BookingLifecycleResponse", ref: "#/components/schemas/BookingLifecycleResponse" },
  { name: "BookingAgoraBlock", ref: "#/components/schemas/BookingAgoraBlock" },
  { name: "AttachBookingSessionResponse", ref: "#/components/schemas/AttachBookingSessionResponse" },
  { name: "BookingHeartbeatRequest", ref: "#/components/schemas/BookingHeartbeatRequest" },
  { name: "BookingHeartbeatResponse", ref: "#/components/schemas/BookingHeartbeatResponse" },
  { name: "HostBookingProfile", ref: "#/components/schemas/HostBookingProfile" },
  { name: "UpsertHostBookingProfileRequest", ref: "#/components/schemas/UpsertHostBookingProfileRequest" },
  { name: "HostBookingAvailabilityRule", ref: "#/components/schemas/HostBookingAvailabilityRule" },
  {
    name: "CreateHostBookingAvailabilityRuleRequest",
    ref: "#/components/schemas/CreateHostBookingAvailabilityRuleRequest",
  },
  {
    name: "UpdateHostBookingAvailabilityRuleRequest",
    ref: "#/components/schemas/UpdateHostBookingAvailabilityRuleRequest",
  },
  {
    name: "HostBookingAvailabilityRuleListResponse",
    ref: "#/components/schemas/HostBookingAvailabilityRuleListResponse",
  },
  { name: "HostBookingAvailabilityException", ref: "#/components/schemas/HostBookingAvailabilityException" },
  {
    name: "CreateHostBookingAvailabilityExceptionRequest",
    ref: "#/components/schemas/CreateHostBookingAvailabilityExceptionRequest",
  },
  {
    name: "UpdateHostBookingAvailabilityExceptionRequest",
    ref: "#/components/schemas/UpdateHostBookingAvailabilityExceptionRequest",
  },
  {
    name: "HostBookingAvailabilityExceptionListResponse",
    ref: "#/components/schemas/HostBookingAvailabilityExceptionListResponse",
  },
  { name: "HostBookingPriceRule", ref: "#/components/schemas/HostBookingPriceRule" },
  { name: "CreateHostBookingPriceRuleRequest", ref: "#/components/schemas/CreateHostBookingPriceRuleRequest" },
  { name: "UpdateHostBookingPriceRuleRequest", ref: "#/components/schemas/UpdateHostBookingPriceRuleRequest" },
  { name: "HostBookingPriceRuleListResponse", ref: "#/components/schemas/HostBookingPriceRuleListResponse" },

...
function usage(): never {
  console.error(`Usage:
  bun scripts/turso-control-plane.ts provision-community --community-id ID --creator-user-id ID --display-name NAME --namespace-verification-id ID --group-location LOC [options]
  bun scripts/turso-control-plane.ts rotate-community-token --community-id ID [options]
  bun scripts/turso-control-plane.ts doctor [--community-id ID]

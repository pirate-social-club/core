...
function usage(): never {
  console.error(`Usage:
  bun scripts/infisical/bootstrap-infisical.ts --env ENV [--dry-run]
...
Set env vars before running:
  ...
  bun scripts/infisical/bootstrap-infisical.ts --env dev
...
console.log(`  bun scripts/infisical/check-infisical-env.ts --env ${options.env} --connect`);

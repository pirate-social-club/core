...
function usage(): never {
  console.error(`Usage:
  bun scripts/community/bootstrap-community-slice.ts --database-url-env ENV_NAME --community-db PATH --community-id ID --user-id ID --display-name NAME --namespace-verification-id ID [options]
...
const bootstrap = Bun.spawnSync(
  [
    "bash",
    resolve("scripts/community/bootstrap-community-db.sh"),
    "--db",
    communityDbPath,
    "--community-id",
    options.communityId,

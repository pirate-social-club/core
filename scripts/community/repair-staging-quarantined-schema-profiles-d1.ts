...
const PROFILE_COLUMNS: Record<Profile, readonly { table: string; column: string }[]> = {
  ...
  replay_and_streaks: [
    ...
    { table: "live_room_replay_assets", column: "recording_id" },
    { table: "live_room_replay_assets", column: "moderation_status" },
    { table: "song_engagement_days", column: "activity_timezone" },
    { table: "song_streaks", column: "owner_timezone" },
    { table: "song_streaks", column: "owner_timezone_updated_at" },
  ],
}
...
const PROFILE_INDEXES: Record<Profile, readonly string[]> = {
  ...
  replay_and_streaks: [
    ...
    "idx_live_room_replay_allocations_recording",
    "idx_song_engagement_days_user_date",
    "idx_song_streaks_community_current",
  ],
}

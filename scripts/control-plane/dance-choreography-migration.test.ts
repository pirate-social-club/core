...
const MIGRATION_FILES = [
  ...
  "db/control-plane/migrations/0208_control_plane_dance_consent_contract_tightening.sql",
]
...
describe.skipIf(!RUN)("dance migrations 0168-0171 and 0201-0208 (real Postgres)", () => {
  beforeAll(async () => {
    const root = connect()

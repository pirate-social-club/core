...
export const ENV_CONTRACT: EnvContract = {
  ...
  secrets: [
    ...
    {
      path: "/services/api",
      key: "STORY_RUNTIME_FUNDER_PRIVATE_KEY",
      requiredness: "deferred",
    },
    {
      path: "/services/api",
      key: "STORY_PURCHASE_ENTITLEMENT_TOKEN_CONTRACT",
      requiredness: "deferred",
      validate: isEvmAddress,
    },
    {
      path: "/services/api",
      key: "STORY_PIRATE_SIGNER_REGISTRY_CONTRACT",
      requiredness: "deferred",
      validate: isEvmAddress,
    },
    {
      path: "/services/api",
      key: "STORY_TOKEN_GATE_CONDITION_CONTRACT",
      requiredness: "deferred",
      validate: isEvmAddress,
    },
    {
      path: "/services/api",
      key: "STORY_SIGNED_ACCESS_CONDITION_CONTRACT",
      requiredness: "deferred",
      validate: isEvmAddress,
    },
    {
      path: "/services/api",
      key: "STORY_ASSET_PUBLISH_COORDINATOR_CONTRACT",
      requiredness: "deferred",
      validate: isEvmAddress,
    },
    {
      path: "/services/api",
      key: "STORY_MARKETPLACE_SETTLEMENT_CONTRACT",
      requiredness: "deferred",
      validate: isEvmAddress,
    },
    {
      path: "/services/api",
      key: "STORY_ENTITLEMENT_CLASS_CONFIGURER_CONTRACT",
      requiredness: "deferred",
      validate: isEvmAddress,
    },
    {
    ...
    {
      path: "/services/api",
      key: "STORY_DELIVERY_OWNER_ADDRESS",
      requiredness: "deferred",
      validate: isEvmAddress,
    },
    {

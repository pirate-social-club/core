...
const basePost: PostCardProps = {
  viewContext: "home",
  byline: {
    guild: { kind: "guild", label: "g/tameimpala", href: "#", avatarSrc: "https://i.pravatar.cc/100?img=10" },
  ...
  render: () => (
    <PostCard
      ...
      content={{
        ...
        linkTitle: "How We Think About Ranking Music Guilds",
...
export const NoGuildContext: Story = {
  name: "Layout: No Guild",
  render: () => (
    <PostCard
      viewContext="profile"
      byline={{
  ...
  render: () => (
    <PostCard
      ...
      byline={{
        ...
        guild: { kind: "guild", label: "g/music", href: "#" },
      }}
...
export const GuildFeedPost: Story = {
  name: "Layout: Guild Feed",
  render: () => (
    <PostCard
      {...basePost}
      viewContext="guild"
      byline={{
        guild: { kind: "guild", label: "g/tameimpala", href: "#" },

...
and Subject. To is intentionally not a proof obligation or public output in the
work→personal ceremony. A valid but unaligned forwarder or mailing-list
signature does not pass the gate.

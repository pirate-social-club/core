-- Admit the scorer's two sequence-level rejection reasons without weakening
-- the original bounded terminal reason contract.

CREATE TABLE dance_attempt_next (
    ...
    reason_code TEXT CHECK (
        ...
        OR reason_code IN (
            ...
            'version_mismatch', 'insufficient_motion', 'insufficient_alignment'
        )
    ),
...
INSERT INTO dance_attempt_next
SELECT * FROM dance_attempt;

DROP TABLE dance_attempt;
ALTER TABLE dance_attempt_next RENAME TO dance_attempt;

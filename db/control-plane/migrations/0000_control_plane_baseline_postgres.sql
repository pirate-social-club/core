...
CREATE TABLE profiles (
    ...
    display_name TEXT,
    bio TEXT,
    bio_source TEXT CHECK (bio_source IS NULL OR bio_source IN ('ens', 'manual', 'none')),
    avatar_ref TEXT,
    avatar_source TEXT CHECK (avatar_source IS NULL OR avatar_source IN ('ens', 'upload', 'none')),
    cover_ref TEXT,
